...
import { itensDeLista1EstaoEmLista2 } from "@/operacaoes/listas";
  ...
  <section class="mostrar-receitas">
    ...
    <div v-if="receitasEncontradas.length" class="receitas-wrapper">
      <p class="paragrafo-lg informacoes">
        Vejas as opções de receitas que encontramos com os ingredientes que você tem por aí!
      </p>
    ...
    <div v-else class="receitas-nao-encontradas">
      <p class="paragrafo-lg receitas-nao-contradas__info">
        <img src="../assets/images/sem-receitas.png" alt="Desenho de um ovo quebrado. A gema tem um rosto com uma expressão triste."></img>
