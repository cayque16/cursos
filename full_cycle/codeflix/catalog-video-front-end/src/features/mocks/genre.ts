export const genreResponse = {
    ...
    links: {
      ...
      last: "http://192.168.2.10:8080/api/genres?page=7",
      prev: null,
      next: "http://192.168.2.10:8080/api/genres?page=2",
    },
    meta: {
      current_page: 1,
      from: 1,
  ...
  export const genreResponsePage2 = {
    ...
    links: {
      first: "http://192.168.2.10:8080/api/genres?page=1",
      last: "http://192.168.2.10:8080/api/genres?page=7",
      prev: "http://192.168.2.10:8080/api/genres?page=1",
      next: "http://192.168.2.10:8080/api/genres?page=3",
    },
    meta: {
      current_page: 2,
      from: 16,
