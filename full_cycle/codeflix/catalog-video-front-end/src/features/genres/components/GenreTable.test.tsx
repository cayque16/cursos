...
describe("GenresTable", () => {
  ...
  it("should render GenreTable with data", () => {
    const { asFragment } = renderWithProviders(
      <GenreTable {...Props} data={mockData} />
    );
    expect(asFragment()).toMatchSnapshot();
  });

  it("should render GenreTable with data and loading", () => {
    const { asFragment } = renderWithProviders(
      <GenreTable {...Props} data={mockData} isFetching={true} />
    );
    expect(asFragment()).toMatchSnapshot();
  });

  it("should render GenreTable with data and loading and delete", () => {
    const { asFragment } = renderWithProviders(
      <GenreTable
        {...Props}
        data={mockData}
  ...
  it("should render GenreTable with data categories", () => {
    const { asFragment } = renderWithProviders(
      <GenreTable
        {...Props}
        data={{
